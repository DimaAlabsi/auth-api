...
describe('Auth Router', () => {
    ...
    describe('bad logins', () => {
        it('signing in using incorrect password (Basic Auth)', async () => {
        ...
        it('signing in with unknown user (Basic Auth)', async () => {
        ...
        it(' bearer fails with an invalid token (Bearer Auth)', async () => {
